...
class TurkAnime : MainAPI() {
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        var archivePoster: String? = null
        var archiveBanner: String? = null
        ...
        try {
            ...
            // Arşivdeki afiş/poster alanlarını oku
            archivePoster = info.optString("Afiş").takeIf { it.isNotBlank() }
                ...
                ?: info.optString("resim").takeIf { it.isNotBlank() }
                ?: info.optString("Görsel").takeIf { it.isNotBlank() }
                ?: info.optString("gorsel").takeIf { it.isNotBlank() }
        ...
        val searchCandidate = title.substringBefore(" (").trim()

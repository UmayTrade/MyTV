...
// ! Güncelleme: 03.09.2026 - Derleme hataları giderildi.
...
class DiziPal : MainAPI() {
    ...
    // ! DÜZELTİLDİ: episode ve season alanları kaldırıldı (newTvSeriesSearchResponse'de yoklar)
    private fun Element.sonBolumler(): SearchResponse? {
        ...
        return newTvSeriesSearchResponse(title, seriesUrl, TvType.TvSeries) {
            ...
            // ! NOT: episode ve season burada ayarlanamaz, newTvSeriesSearchResponse bunları desteklemez
        }
    }

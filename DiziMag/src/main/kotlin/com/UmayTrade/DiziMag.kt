...
class DiziMag : MainAPI() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        // Yeni eklenenler için özel seçici
        if (request.name.contains("Yeni Eklenenler")) {
            ...
            // Alternatif seçici - eğer yukarıdaki çalışmazsa
            if (home.isEmpty()) {
    ...
    // Yeni eklenenler için özel fonksiyon
    ...
    override suspend fun loadLinks(
        ...
        // Eğer bePlayer bulunamadıysa fallback
